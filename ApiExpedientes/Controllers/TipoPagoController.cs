...
namespace ApiExpedientes.Controllers
{
    public class TipoPagoController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TipoPagoId,TipoPago1")] TipoPago tipoPago)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TipoPagoId,TipoPago1")] TipoPago tipoPago)
        {
            if (ModelState.IsValid)
            {
